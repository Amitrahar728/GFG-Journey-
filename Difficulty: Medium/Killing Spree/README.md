<h2><a href="https://www.geeksforgeeks.org/problems/killing-spree3020/1?page=3&category=Binary%20Search&sortBy=submissions">Killing Spree</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">There are Infinite People Standing in a row, indexed from 1.<br>
